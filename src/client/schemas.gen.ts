...
export const UnpublishWorkflowResponseSchema = {
  ...
  properties: {
    workflowId: {
      type: "string",
      description: "UUID identifier of the workflow unpublished (echoed)",
    },
    draftVersion: {
      type: "integer",
    ...
    unpublished: {
      type: "boolean",
      description: "Indicates if the workflow was successfully unpublished",
    },
  },
} as const;
...
export const PublishWorkflowCommandSchema = {
  ...
  properties: {
    ...
    description: {
      ...
      example: "Customer onboarding workflow v2.1",
    },
  },
} as const;
...
export const PublishWorkflowResponseSchema = {
  ...
  properties: {
    workflowId: {
      type: "string",
      description: "UUID identifier of the workflow published (echoed)",
    },
    publishedVersion: {
      type: "integer",
    ...
    published: {
      type: "boolean",
      description: "Indicates if the workflow was successfully published",
    },
  },
} as const;
