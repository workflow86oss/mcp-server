...
export type UnpublishWorkflowResponse = {
  /**
   * UUID identifier of the workflow unpublished (echoed)
   */
  workflowId?: string;
  /**
  ...
  draftVersion?: number;
  /**
   * Indicates if the workflow was successfully unpublished
   */
  unpublished?: boolean;
};
...
export type PublishWorkflowCommand = {
  ...
  comment?: string;
  /**
   * Description of this workflow version
   */
  description?: string;
};
...
export type PublishWorkflowResponse = {
  /**
   * UUID identifier of the workflow published (echoed)
   */
  workflowId?: string;
  /**
  ...
  draftVersion?: number;
  /**
   * Indicates if the workflow was successfully published
   */
  published?: boolean;
};
