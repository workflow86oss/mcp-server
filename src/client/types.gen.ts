...
/**
 * Request to update workflow details
 */
export type UpdateWorkflowDetailsCommand = {
  /**
...
export type UpdateWorkflowDetailsData = {
  body: UpdateWorkflowDetailsCommand;
  path: {
    workflowId: string;
  };
  query?: never;
...
export type UpdateWorkflowDetailsErrors = {
  /**
...
export type UpdateWorkflowDetailsError =
  UpdateWorkflowDetailsErrors[keyof UpdateWorkflowDetailsErrors];

export type UpdateWorkflowDetailsResponses = {
  /**
   * OK
   */
